    ...
    <div className="operator-page">
      <header className="operator-page-header">
        <div>
          ...
          <h1>You decide where Yumna can act alone.</h1>
      ...
      <section className="operator-section">
        <div className="operator-section-heading">
          <div><span className="operator-kicker">Current permissions</span><h2>What Yumna may do</h2></div>
        </div>
        <div className="operator-rule-list">
          {rules.length ? rules.map((rule) => (
            ...
            <div className="operator-empty">
              ...
              <span>Yumna will ask before consequential actions.</span>
            </div>
          )}
        </div>
      </section>
