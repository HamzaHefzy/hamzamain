    ...
    <div className="operator-page">
      <header className="operator-page-header">
        <div>
          ...
          <h1>Teach Operator how your life works.</h1>
      ...
      <section className="operator-section">
        ...
        <div className="operator-memory-list">
          ...
          )) : <div className="operator-empty"><strong>Operator has no saved preferences yet.</strong><span>Add the things you never want to repeat.</span></div>}
        </div>
      </section>
    </div>
  );
