    ...
    <div className="operator-page">
      <header className="operator-page-header">
        <div>
          ...
          <p>Yumna keeps ownership of the work until there is a real reason to involve you.</p>
        </div>
      ...
      <section className="operator-metrics" aria-label="Workspace summary">
        <article><span>Active</span><strong>{overview.counts.active}</strong><small>tasks Yumna still owns</small></article>
