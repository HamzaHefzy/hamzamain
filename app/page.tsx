      ...
      <main>
        <section className="operator-hero">
          <div>
            ...
            <h1>Give Wafira the work you don&apos;t want to carry.</h1>
            <p>
              Wafira finds the right business, gets the number, makes the call,
            ...
            <div className="operator-hero-actions">
              <Link href="/signup">Start with Wafira</Link>
              <a href="#how">See how it works</a>
            </div>
          </div>

          <div className="operator-demo-window" aria-label="Illustrative Wafira task">
        ...
        <section className="operator-feature-strip" id="how">
          ...
          <article><strong>Stay in control</strong><span>You decide what Wafira may do without another tap.</span></article>
        </section>
        ...
        <section className="operator-marketing-section" id="use-cases">
          ...
          <p>
            Wafira is built for work that crosses apps and the physical world—the
          ...
          <div className="operator-usecases">
            ...
            <article><strong>Recurring life admin</strong><span>Set routines once and let Wafira create governed tasks automatically.</span></article>
          </div>
        </section>
      </main>
    </div>
