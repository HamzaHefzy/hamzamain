    ...
    <div className="y-public-site">
      ...
      <main className="y-content-page">
        ...
        <section className="y-product-stack">
          ...
          <article><div className="y-product-icon">☎</div><div><span>Voice</span><h2>Real phone calls are part of the workflow.</h2><p>Yumna can resolve a business number, identify itself as your automated assistant, handle the conversation, and return the result to the same task thread.</p></div></article>
