...
export const metadata = {
  title: "Security",
  description: "Operator security architecture and trust controls.",
};
    ...
    <div className="marketing-site trust-site">
      ...
      <main className="m-container trust-main">
        <div className="m-section-heading centered trust-heading">
          ...
          <p>Operator separates identity, authority, execution, and audit so a useful assistant does not require unlimited permission.</p>
        </div>
        <div className="trust-grid">
          ...
          <article><h2>Signed callbacks</h2><p>Asynchronous executors resume tasks only through a bearer-secret callback endpoint. Stripe events use timestamped HMAC signature verification and replay-safe event IDs.</p></article>
