  ...
  return (
    <div className="public-form-page">
      ...
      <main className="auth-card">
        ...
        <h1>Create your Wafira</h1>
        <p>Your workspace starts with default-deny authority. Wafira asks before consequential actions until you explicitly grant a rule.</p>
        <SignupForm />
